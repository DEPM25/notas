...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('asignaciones', function (Blueprint $table) {
            ...
            $table->foreign(['periodo_jornada_id'])->references(['id'])->on('periodos_jornadas');
            $table->foreign(['anio_escolar_id'])->references(['id'])->on('anios_escolares');
            $table->foreign(['grupo_id'])->references(['id'])->on('grupos');
            $table->foreign(['usuario_docente_id'])->references(['id'])->on('usuarios');
        });
    }
    ...
    public function down()
    {
        Schema::table('asignaciones', function (Blueprint $table) {
            ...
            $table->dropForeign('asignaciones_periodo_jornada_id_foreign');
